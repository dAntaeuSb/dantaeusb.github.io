...
function colorcolor(color, newColor, calculateOpacity) {
    ...
    switch (newColor) {
        ...
        case "hexa":
            if (calculateOpacity) {
                _a = calculateOpacityFromWhite(r, g, b, a), r = _a[0], g = _a[1], b = _a[2], a = _a[3];
            }
        ...
        case "hsla":
            if (calculateOpacity) {
                _b = calculateOpacityFromWhite(r, g, b, a), r = _b[0], g = _b[1], b = _b[2], a = _b[3];
            }
        ...
        default:
            if (calculateOpacity) {
                _c = calculateOpacityFromWhite(r, g, b, a), r = _c[0], g = _c[1], b = _c[2], a = _c[3];
            }
